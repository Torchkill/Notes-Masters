...
-Assess and implement in Python heuristics, optimization algorithms, and game evaluation functions.
-Assess and implement in Python inference techniques in a probabilistic setting.
-Evaluate which type of problems and settings require the application of data-driven or knowledge-based techniques.
...
__Content:__
 ...
 - 	Optimization techniques, including local search and  hill-climbing, and constraint satisfaction problems.
 - 	Overview of applications of search, logic, and probability in real world AI technology.
