...
\textbf{Rappaport}
\begin{itemize}
    \item Chapter 6 (Updated second edition), 
    \item Chapter 5 (Second edition). Modulation Techniques for Mobile Radio
    \item Skip section 5.3.2+, 5.5 and 5.7.4. Read to section 5.9.3.
\end{itemize}
