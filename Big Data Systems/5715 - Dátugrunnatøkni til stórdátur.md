# 5715 - Dátugrunnatøkni til stórdátur
...
Tá skeiðið er lokið, skal tann lesandi vera før/ur fyri at:
 ...
 - 	Greiða frá, nýta og grundgeva fyri val av grundleggjandi multidimensionellari myndlan.
 - 	Greiða frá og við OLAP-tólum seta í verk dátuvøruhús við dátum frá fleiri dátukeldum við til dømis Extract-Transform-Load (ETL).
 - 	Greiða frá og meta um grundleggjandi útbýttar (distributed) dátugoymslur av heterogenum dátumongdum við til dømis Hadoop Distributed File System (HDFS).
 - 	Greiða frá og meta um ymisk háttaløg fyri at økja um fault-tolerance.
 - 	Greiða frá og við stórdátutólum avrika útbýtta (distributed) dátugreining við til dømis MapReduce ella Apache Spark.
...
__Innihald__
 ...
 - 	Almenn innleiðing til útbýttar (distributed) dátugoymslur.
 - 	Replikatión og sambæri (consistency) av útbýttum (distributed) dátugoymslum.
 - 	Stórdátugreining.
